...
int main(void)
{
  printf("En el proceso inicial, antes de llamar a execve\n");
  ...
  printf( "ahora ejecutando ./programa13_getenv_user2, los valores de las variables de entorno USER y MI_VARIABLE son: \n" );
