...
int main(void)
{
  ...
  printf( "ahora ejecutando ./programa13_getenv_user1, el valor de la variable de entorno USER es: \n" );
  if( execle("./programa13_getenv_user1", "./programa13_getenv_user1", NULL, variables_entorno) == -1)
  {
