...
public class EjemploLlaveSimetricaDES
{
 public static void main (String[] args) throws Exception
 {
  ...
  int keyBitSize = cifrar.getOutputSize(0) * Byte.SIZE;
  System.out.println( "keyBitSize=" + keyBitSize );
  byte[] cipherText = cifrar.doFinal(textoPlano);
  System.out.println( "El argumento ENCRIPTADO es:" );
  // NO SE DEBE PASAR A String
  System.out.println( "COMO STRING:" + new String(cipherText, "UTF8") );
